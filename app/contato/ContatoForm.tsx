...
const inputClass =
  "w-full rounded border border-gray-300 bg-white px-4 py-3 text-base text-gray-900 focus:border-purple-800 focus:outline-none focus:ring-1 focus:ring-luxury-accent/30";
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 px-4 py-6 sm:px-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {[
          { title: "E-mail", value: "contato@mulheresdeluxo.com.br" },
      ...
      {sent ? (
        <div className="rounded-lg border border-green-200 bg-green-50 p-6 text-center">
          ...
          <button
            ...
            className="mt-4 text-base text-luxury-accent underline"
          >
            Enviar outra
          </button>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-[#0c0414] py-3 text-base font-medium text-white hover:bg-purple-900"
          >
            Enviar
          </button>
        </form>
