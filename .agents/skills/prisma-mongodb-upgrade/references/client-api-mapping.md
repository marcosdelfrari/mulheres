...
- [v6 MongoDB raw queries](https://prisma.io/docs/orm/prisma-client/using-raw-sql/raw-queries#raw-queries-with-mongodb)
- [v6 replica set requirement for transactions](https://prisma.io/docs/orm/overview/databases/mongodb#replica-set-configuration)
