...
- [Official v7 Upgrade Guide](https://prisma.io/docs/orm/more/upgrades/to-v7)
- [Driver Adapters Documentation](https://prisma.io/docs/orm/core-concepts/supported-databases/database-drivers)
