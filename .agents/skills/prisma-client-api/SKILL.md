...
- [Prisma Client API Reference](https://prisma.io/docs/orm/reference/prisma-client-reference)
- [CRUD Operations](https://prisma.io/docs/orm/prisma-client/queries/crud)
- [Filtering and Sorting](https://prisma.io/docs/orm/prisma-client/queries/filtering-and-sorting)
